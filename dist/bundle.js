...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,WAAW;IACX,YAAY;IACZ,uBAAuB;IACvB,aAAa;IACb,2BAA2B;IAC3B,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,0CAA0C;AAC9C;;AAEA;IACI,qBAAqB;AACzB","sourcesContent":[".mainContent { \n    width: 98vw;\n    height: 50vh;\n    border: 1px solid black;\n    display: grid;\n    grid-template-rows: 1fr 9fr;\n    margin-right: 2fr;\n}\n\n.containerDiv {\n    display: grid;\n    grid-template-columns: 1fr 2fr;\n    border: 1px solid black;\n}\n\n.locationDetails, .currentDetails {\n    display: grid;\n    border: 1px solid black;\n}\n\n.locationDetails>div, .currentDetails>div {\n    display: grid;\n    border: 1px solid black;\n}\n\n.swal-overlay {\n    background-color: rgba(111, 175, 9, 0.568);\n}\n\n.swal-modal {\n    border: 5px solid red;\n}"],"sourceRoot":""}]);
// Exports
...
(0,_modules_domStuff_js__WEBPACK_IMPORTED_MODULE_1__.doDomStuff)().appendImage();
